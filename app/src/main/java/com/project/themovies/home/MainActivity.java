...
import com.project.themovies.databinding.ActivityMainBinding;
import com.project.themovies.home.favorite.FragmentFavorite;
import com.project.themovies.home.movie.FragmentMovie;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backgroundStatusBar();
        binding.toolbar.imgNotification.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onNavigationChanged(View view, int position) {
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        Toast.makeText(MainActivity.this, "Segera Tersedia", Toast.LENGTH_SHORT).show();
                        break;
                    case 2:
